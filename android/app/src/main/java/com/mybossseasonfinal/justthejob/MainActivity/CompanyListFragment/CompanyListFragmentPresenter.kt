...
class CompanyListFragmentPresenter @Inject constructor(
    ...
    fun getMatchingCompanyList(): MutableList<Company> {
        return mutableListOf<Company>(
                Company(_id = "1", id = 1, name = "NTT docomo", founder = "吉澤社長", founding = "1993", address = "溜池山王"),
                Company(_id = "2", id = 2, name = "野村総合研究所", founder = "？？？", founding = "????", address = "横浜みなとみらい"),
                Company(_id = "3", id = 3, name = "NTTデータ", founder = "？？？", founding = "????", address = "豊洲")
        )
    }
}