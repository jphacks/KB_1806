...
class CompanyListFragmentPresenter @Inject constructor(
    ...
    fun getMatchingCompanyList(): MutableList<Company> {
        return mutableListOf(
                Company(_id = "1", id = 1, name = "NTT docomo", founder = "吉澤社長", founding = "1993", address = "溜池山王", img_path = "https://s3-ap-northeast-1.amazonaws.com/jphacks2018.images/docomo.jpg"),
